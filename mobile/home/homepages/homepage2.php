...
<div class="page-content header-clear-medium">
        ...
        <div class="card card-style bg-20" data-card-height="200" 
            ...
            <div class="card-bottom ps-3 pb-2 bt-3">
                <h3 class="font-15"><a href="fund-wallet" style="text-shadow: 2px 2px 2px #000000;"><b class="text-white">Click Here To Fund Your Wallet</b></a><br><a href="#">DOWNLOAD APP ON PLAY STORE</a></h3>
            </div>
        ...
        <div class="card card-style mt-3">
          ...
          <center></center><a href="#"><img src="/app.png" alt="" style="max-width: 200px; max-height: 150px;"></a><br><br></center>
