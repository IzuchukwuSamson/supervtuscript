            ...
            <div class="content">
                ...
                <div class="px-2">
                    ...
                    <div class="input-style  no-borders has-icon mb-4">
                        ...
                        <input type="number" value="<?php if(isset($_GET["referral"])): echo $_GET["referral"]; endif; ?>" class="form-control" id="referal" name="referal" placeholder="Enter Phone Number Again For Cashbacks" required />
                        <label for="referal" class="color-highlight">Phone Number</label>
                        <em>(required)</em>
                    </div>
