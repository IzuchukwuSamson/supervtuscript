...
<style>
    body{background-image:url("../../assets/img/blake-wisz-tE6th1h6Bfk-unsplash.jpg");  background-repeat: no-repeat; background-size: cover;}
    ...
    <div class="card card-style" style="min-width:450px; padding:20px;">
            <div class="content">
                ...
                <div class="text-center">
                    <div class="pb-3 pt-3">
                        <!--<img src="../../assets/img/favicon.png"  class="img-fluid" width="250" />-->
                    </div>
                ...
                <div class="px-2">
                    ...
                    <a id="next-btn" style="width: 100%; background-color:<?php echo $sitecolor; ?>;" class="btn btn-full btn-l font-600 font-15 btn-dark mt-4 rounded-s">
                        Continue
                    </a>
                    ...
                    No Referral? Enter Your Phone Number To recieve Commissions On Your Purchases
                    
                    <button type="submit" id="submit-btn" style="width: 100%; background-color:<?php echo $sitecolor; ?>;" class="btn btn-full btn-l font-600 font-15 btn-dark mt-4 rounded-s ">
                        Register
                    </button>
                    ...
                    <div class="col-12 text-center font-15 mt-3">
                        <a class="text-dark"<b>Theme by MUGIS & BROTHERS</a>
                    </div>
