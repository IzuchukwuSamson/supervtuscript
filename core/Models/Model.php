<?php
	...
	class Model{
		...
		public static $dbName="daltechsub_omooba"; //Database Name
		public static $username="daltechsub_omooba"; // Database Username
		public static $password="+q-2=OtIg!?k"; //Database Password

        public static $dbh;
        
		public $emailUsername="support@omoobatelecom.com.ng"; //Support Email Address
		public $emailPassword="6m3yE!-E)!Mf"; //Support Email Password
		...
		public function sendMail($email,$subject,$message){
	        ...
	        try {
                ...
                //Recipients
                $mail->setFrom($this->emailUsername, "omoobatelecom");
