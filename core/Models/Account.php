<?php
   ...
   // Text to send to user
          ...
          $message = "Hello " . $result->sFname . ",<br><br>";
          $message .= "This is a login notification from OMOOBATELECOM. We wanted to inform you that your account was recently accessed.<br><br>";
          $message .= "If you didn't initiate this login, please contact our customer support on support@omoobatelecom.com.ng immediately.\n\n";
    
  // Device Information
        $message .= "<h4>Device Information</h4>";
        $message .= "<b>Device: </b>" . $userAgent . "<br><br>";
        $message .= "<b>IP Address: </b> " . $ipAddress . "<br><br>";
        $message .= "<b>Date & Time:</b> " . date("M, d Y h:i A") . "<br><br>";
        $message .= "Thank you for choosing OMOOBATELECOM. <br><br>";
        $message .= "Best regards,<br> The OMOOBATELECOM Team";

  // Include the email sending code here
        self::sendMail($result->sEmail, $subject, $message);
